...
const Landing = () => {
    return (
        <div className="container-wrapper">
            {/* <h1>Parallax Landing Page</h1> */}
            <Row className="no-gutters">

                <Col lg={6} style={{ backgroundColor: "black", color: "white" }}>
                    <h1 className="text-left">My Intro Page</h1>
                    <div id="wrapper" className='w-100'>
                        <p className="headerPara">The Green Nephrology Action Team(GNAT) is a working group of the Australian
                    and New Zealand Society of Nephrology(ANZSN). It has a tripartite support of:
                            Australia and New Zealand Society of Nephrology(ANZSN)<br />
                            The Renal Society of Australia(RSA)<br />
                            Kidney Health Australia(KHA)<br /></p>

                        <p className="headerPara">The Green team draws representatives from the ANZSN, RSA, KHA, and consumer groups. </p>
                    </div>
                </Col>

                <Col lg={6}>
                    <img className="w-100" src="" alt="About" style={{ float: "right", width: "100%", height: "100%" }} />
                </Col>
            </Row>
